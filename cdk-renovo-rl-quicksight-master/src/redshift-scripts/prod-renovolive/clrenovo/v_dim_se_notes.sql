CREATE OR REPLACE VIEW clrenovo.v_dim_se_notes AS WITH
serviceeventid_notes2_cte AS (
	...
	FROM clrenovo.v_se_assignedUsers sau
    JOIN clrenovo.v_se_serviceNotes note ON sau.serviceEventID = note.serviceEventID
