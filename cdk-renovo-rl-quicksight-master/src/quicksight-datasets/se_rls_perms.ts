...
export interface RenovoLiveSeRlsPermsDataSetProps extends StackProps {
  /**
...
export class RenovoLiveSeRlsPermsDataSet extends Stack {
  constructor(scope: Construct, id: string, props: RenovoLiveSeRlsPermsDataSetProps) {
    super(scope, id, props);

    new cfninc.CfnInclude(this, 'vRlsServiceEventsTemplate', {
      templateFile: path.join(__dirname, 'se_rls_perms.json'),
      parameters: {
